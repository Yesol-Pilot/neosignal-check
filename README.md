...
```bash
curl -sLo check.py https://raw.githubusercontent.com/Yesol-Pilot/neosignal-check/v2026.08.05.4/neosignal_check.py
python check.py . --quiet
```
...
<!--size:start-->
**1113 lines, one file, no dependencies.**
